...
static void cputchar(int x)
{
  ...
  // Hazard3/rvcpp:
  *(volatile uint32_t*)IO_PRINT_CHAR = x;
}
...
# error
#endif
  // (Hazard3/rvcpp) map IO at its phys location, with user permissions
  l1pt[IO_BASE >> 22] = (IO_BASE >> 2) | PTE_V | PTE_R | PTE_W | PTE_A | PTE_D | PTE_U;
